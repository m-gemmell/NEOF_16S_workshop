...
- PairedEndFastqManifestPhred33.csv
   - This file contains three columns that are separated by commas (.csv = comma separated values). This is vital for importing your sequencing data into QIIME2. More info on this file in chapter 7.
- metadata.file.txt
   - This file contains metadata. This file contains columns seperated by tabs. It is vital that the "sample-id" column contains the same info as the "sample-id" column in "PairedEndFastqManifestPhred33.csv". More info on this file in chpater 7.
...
Take a look at the contents of your current directory. There should be the following files:
...
__MG__
(Update this to include that people can cat the file primers_seqs.fasta to copy and paster the primer sequences)
