...
1. sample-id
   - This is a user specified sample-id. 
...
This file will be used in chapter 7. For more information
...
## metadata.file.txt
   - This file contains metadata. This file contains columns seperated by tabs. It is vital that the "sample-id" column contains the same info as the "sample-id" column in "PairedEndFastqManifestPhred33.csv". More info on this file in chapter 7.
