...
Note: Do not run the below command for this tutorial, see `cp` command further down.
...
This uses Naive Bayes which is a very complicated algorithm. Thankfully we don't need to know how it works so we will not explain how it works.
