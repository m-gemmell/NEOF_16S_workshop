...
The steps for the analysis are listed below, mainly taken from https://docs.qiime2.org/2019.1/tutorials/.
...
This is a fasta file containing the forward and reverse 16S rRNA primer sequences. These are needed for PCR trimming step (chapter 8) and the classifier training step (chapter 10).
...
For your own studies you will need to ask the lab that carried out the sequencing preparation for the primer sequences.
...
With our trained classifier we can assign taxonomic assignments to the ASV represenative sequences:
...
- Many of the individual samples (__BarcodeSequence__) have plateaued with the others plateauing this depth.
