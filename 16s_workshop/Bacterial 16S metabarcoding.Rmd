...
-   **`--o-differentials`**: Output <u id='artifact_tip'>artifact</u> containing the calculated differentials. This will be used to produce visualisation <u id='artifact_tip'>artifacts</u>.
...
--i-table table-l5.qza \
--m-metadata-file metadata.file.txt \
--p-fixed-effect-formula Location \
