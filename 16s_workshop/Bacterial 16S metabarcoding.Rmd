...
- __`--output-path`__: Output QIIME2 artifact file contiang your sequence data.
...
- __`--o-alignment`__: Output artifact containing the aligned represenative sequences.
...
All these steps should finish in approximately 3 minutes. The final artifact for later use is ‘rooted-tree.qza’. This is a rooted tree that will be used for some biodiveristy measures that require phylogenetic information.

The file ‘rooted-tree.qza’ contains a phylogentic tree that can be exported to a newick file. This is covered in the [supplemental book](http://www.cgr.liv.ac.uk/illum/NEOFworkshops_5bfa93ca0482d69d/16S/16s_supplemental/02-Exporting_artifacts.html#phylogenetic-tree-export).
...
```
1. At approximately what sequencing depth do the rarefaction of most of the samples (>90%) plateau'd?  `r longmcq(opts_p)`
...
```{r, echo = FALSE}
opts_p <- c("__70,000__", "__90,000__", answer="__115,000 __")
```
