...
<center>![](figures/NEOF_bordered.png){style="width:300px"}</center>

# Introduction

<center>![](figures/intro_logo.png){style="width: 300px"}</center>
...
<center>![](figures/background.png){style="width:200px"}</center>
...
<center>![](figures/16srna.png){style="width: 600px"}</center>
...
```{r, fig.align = 'center',out.width= '900px', echo=FALSE }
...
## Workflow
<center>![](figures/workflow.png){style="width:150px"}</center>

The steps for the analysis are listed below, mainly taken from https://docs.qiime2.org/2023.5/tutorials/.

<center>![](figures/16_tutorial_diagram.png){style="width:800px"}</center>
...
<center>![](figures/prepare.png){style="width:150px"}</center>
...
### OTUs
<center>![](figures/clusters.png){style="width:150px"}</center>
...
### ASVs
<center>![](figures/mangify_glass.png){style="width:150px"}</center>
...
<center>![](figures/ASC_otu_comparison.png){style="width:800px"}</center>
...
<center>![](figures/classification.png){style="width:150px"}</center>
...
<center>![](figures/phylo_tree.png){style="width:150px"}</center>
...
## Data normalisation
<center>![](figures/normalisation.png){style="width:150px"}</center>
...
## Alpha-diversity
<center>![](figures/alpha_div.png){style="width:150px"}</center>
...
## Beta-diversity
<center>![](figures/beta_div.png){style="width:200px"}</center>
...
<center>![](figures/comparison.png){style="width:200px"}</center>
...
<center>![](figures/cluster.png){style="width:200px"}</center>
...
<center>![](figures/logon_pic.png){style="width:700px"}</center>
...
<center>![](figures/terminal_window.png){style="width:800px"}</center>

Already there is useful information for us on the terminal window.

- __nsc206__: This is the login name, also known as the username. In this case nsc006 is a demonstrator's account. Your screen should show a different account name which will be your username for the Linux machine/cluster you are logged into.
...
```{r, fig.align = 'center',out.width= '800px', echo=FALSE, fig.cap= "Example rarefaction curve: We can see that Series 1 plateaus at ~7,000 sequences and Series 3 plateaus at ~18,000 sequences whilst Series 2 has not started to plateau."}
...
```
1. At approximately what sequencing depth do the rarefaction curves of most of the samples (>900px) plateaue?  `r longmcq(opts_p)`
