...
- How is the overall quality for the sequences? 
- Which truncating lengths would you chose for R1 and R2? This choice is base don teh quality across the length of the read plus the total length of our V4 amplicon.
...
The following default options are chosen (no need to look at this it is only for your interest):
