...
2.  Which family has the lowest positive LFC value? I.e. The family with the highest enrichment in Corridor (reference) compared to Toilet (comparison). `r longmcq(opts_p)`
...
5.  Which genus has the lowest positive LFC value? I.e. The genus with the highest enrichment in Corridor (reference) compared to Toilet (comparison). `r longmcq(opts_p)`
...
7.  Which family has the 3rd highest positive LFC value? I.e. The family with the highest enrichment in Main building (comparison) compared to Entrance (reference). `r longmcq(opts_p)`

```{r, echo = FALSE}
opts_p <- c("__Akkermansiaceae__", answer="__Pseudomonadaceae__" , "__Rhodospirillaceae__")
```

8.  Which family has the lowest positive LFC value? I.e. The family with the highest enrichment in Entrance (reference) compared to Main building (comparison). `r longmcq(opts_p)`
...
+ Functional analysis (PICRUSt2). Covered in supplemental!
