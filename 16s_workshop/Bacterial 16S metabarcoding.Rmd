...
__Note__: All the QIIME2 links may be out of date, if so the below will appear:
<center>
![](figures/qiime2_website_out_of_date.png){style="width:600px; border-radius:5px"}
</center>
...
<center>
![](figures/qiime2_version_box.png){style="width:200px; border-radius:5px"}
</center>
...
1. __sample-id__
   ...
   - These must match the sample ids in the [metadata file](#import).
...
[Tutorial on classifying shotgun metageonimc data with Greengenes2](https://forum.qiime2.org/t/introducing-greengenes2-2022-10/25291#if-you-have-shotgun-metagenomic-data-6).
...
# Resources
<center>
![](figures/resources.png){style="width:200px"}
</center>
...
<center>
![](figures/faith_pd.png){style="width:600px"}
</center>
...
<center>
![](figures/beta_div_2.png){style="width:200px"}
</center>
